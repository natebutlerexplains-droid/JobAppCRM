      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/40 rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white hover:bg-slate-50 text-slate-900 font-semibold transition-all duration-200 rounded-lg shadow-lg hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed mb-6"
          >
          ...
          {/* Error Message */}
          {error && (
            <div className="mb-6 p-3.5 bg-red-500/10 border border-red-500/30 rounded-lg">
